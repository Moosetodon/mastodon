...
class Api::V1::StatusesController < ApiController
  ...
  before_action :authorize_if_got_token, except:            [:create, :destroy, :reblog, :unreblog, :favourite, :unfavourite, :bookmark, :unbookmark, :mute, :unmute]
  before_action -> { doorkeeper_authorize! :write }, only:  [:create, :destroy, :reblog, :unreblog, :favourite, :unfavourite, :bookmark, :unbookmark, :mute, :unmute]
